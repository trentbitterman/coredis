...
from coredis.credentials import CredentialProvider, UserPass, UserPassCredentialProvider
...
class Connection(BaseConnection):
    ...
    def __init__(
        ...
        *,
        ...
        self.credential_provider: Optional[CredentialProvider] = credential_provider
